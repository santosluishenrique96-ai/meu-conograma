...
function EvolucaoPage() {
  ...
  const photoAccess = useFeatureAccess("fotos", Boolean(user));
  ...
  const hasPhotoAccess = photoAccess.data?.hasAccess ?? false;
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!hasPhotoAccess) {
      toast.info("Seu plano atual nao libera fotos de evolucao");
    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <FeatureAccessGuard
          featureKey="fotos"
          variant="page"
          title="Desbloqueie sua linha do tempo em fotos"
          description="O registro visual da evolucao capilar fica disponivel apenas para planos com acesso a fotos. Assim que o plano liberar esse recurso, sua galeria abre automaticamente."
        >
